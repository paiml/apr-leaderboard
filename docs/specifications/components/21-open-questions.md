...
7. ✅ **Inference parity gap:** What is the actual pass@1 gap between apr-native inference and PyTorch/HF for Qwen2.5-Coder models? *Answered: 7B Q4K achieves **85.37%** (post-EOS-fix, 512 tokens). HF reference 87.8%, gap = **2.43pp**. 32B Q4K_M achieves **89.63%** vs HF 92.5%, gap = **2.87pp**. Gap attributable to Q4K quantization loss + greedy-only decoding. GPU/CPU parity confirmed.*
