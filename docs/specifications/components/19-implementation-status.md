...
| Contract tests | 54/55 | 55/55 | `make check-contracts` (pass@k ×5, throughput ×2, data ×3, decon ×1, eval ×3, distill ×2, MBPP ×1, gate ×1, quant ×3, distdata ×3, oracle ×2, pipe ×3, compile ×1, catalog ×2, leaderboard ×2, structure ×21). 1 fail: MBPP gate. |
